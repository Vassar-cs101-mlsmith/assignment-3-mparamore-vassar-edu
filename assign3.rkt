...
(define BALL-AT-LEFT 
  (make-ball (circle (+ RADIUS 4) "solid" "teal")
             (+ RADIUS 6) (/ HEIGHT 2) 4 -4))

(define BALL-AT-RIGHT
  (make-ball (circle (+ RADIUS 0 ) "solid" "red")
             (- WIDTH (+ RADIUS 1)) (/ HEIGHT 2) -2 2))

(define BALL-AT-TOP
  (make-ball (circle (+ RADIUS -5) "solid" "green")
             (/ WIDTH 2) (+ RADIUS -2) 3 -2))

(define BALL-AT-BOTTOM 
  (make-ball (circle (+ RADIUS -10) "solid" "orange")
             (/ WIDTH 2) (- HEIGHT RADIUS) 1 5)) 
...
(check-expect (ball-radius BALL-AT-TOP) 20)
...
(check-expect (top-edge? BALL-AT-TOP) #false)
...
(check-expect (bottom-edge? BALL-AT-BOTTOM) #false)
(check-expect (bottom-edge? (make-ball (circle (+ RADIUS 4) "solid" "teal")
             (+ RADIUS 4) (- HEIGHT 5) 4 -4)) #true)
...
(check-expect (left-edge? (make-ball (circle (+ RADIUS 4) "solid" "teal")
             (+ WIDTH 6) (+ HEIGHT 29) 4 -4)) #false)
(check-expect (left-edge? (make-ball (circle (+ RADIUS 4) "solid" "teal")
             (+ WIDTH 50 ) (+ HEIGHT 50) 4 -4)) #false)
...
(check-expect (reverse-up-down BALL-AT-LEFT) (make-ball (circle (+ RADIUS 4) "solid" "teal")
             (+ RADIUS 6) (/ HEIGHT 2) 4 4))
(check-expect (reverse-up-down BALL-AT-RIGHT) (make-ball (circle (+ RADIUS 0 ) "solid" "red")
             (- WIDTH (+ RADIUS 1)) (/ HEIGHT 2) -2 -2))
...
(check-expect (reverse-left-right BALL-AT-LEFT) (make-ball (circle (+ RADIUS 4) "solid" "teal")
             (+ RADIUS 6) (/ HEIGHT 2) -4 -4))
(check-expect (reverse-left-right BALL-AT-RIGHT) (make-ball (circle (+ RADIUS 0 ) "solid" "red")
             (- WIDTH (+ RADIUS 1)) (/ HEIGHT 2) 2 2))
...
(check-expect (reverse-up-down BALL-AT-TOP) (make-ball (circle (+ RADIUS -5) "solid" "green")
             (/ WIDTH 2) (+ RADIUS -2) 3 2))

(check-expect (reverse-up-down BALL-AT-BOTTOM)  (make-ball (circle (+ RADIUS -10) "solid" "orange")
             (/ WIDTH 2) (- HEIGHT RADIUS) 1 -5)) 
...
(check-expect (bounce-left-right BALL-AT-LEFT) (make-ball (circle (+ RADIUS 4) "solid" "teal")
             (+ RADIUS 6) (/ HEIGHT 2) 4 -4))
(check-expect (bounce-left-right BALL-AT-RIGHT) (make-ball (circle (+ RADIUS 0 ) "solid" "red")
             (+ RADIUS 449) (/ HEIGHT 2) -2 2))
...
(check-expect (move-ball BALL-AT-LEFT) (make-ball (circle (+ RADIUS 4) "solid" "teal")
             (+ RADIUS 10) (- (/ HEIGHT 2) 4) 4 -4))
(check-expect (move-ball BALL-AT-RIGHT) (make-ball (circle (+ RADIUS 0 ) "solid" "red")
             (+ RADIUS 447) (+ (/ HEIGHT 2) 2) -2 2))
...
(check-expect (list BALL-AT-LEFT BALL-AT-RIGHT) (list (make-ball (circle (+ RADIUS 4) "solid" "teal")
             (+ RADIUS 6) (/ HEIGHT 2) 4 -4) (make-ball (circle (+ RADIUS 0 ) "solid" "red")
             (+ RADIUS 449) (/ HEIGHT 2) -2 2)))
...
(define (render-ball b bg)
  (place-image (ball-im b)
             (ball-x b) (ball-y b) bg))
                 
(check-expect (render-ball BALL-AT-LEFT BACKGROUND) (place-image (circle (+ RADIUS 4) "solid" "teal")
             (+ RADIUS 6) (/ HEIGHT 2) (place-image (rectangle WIDTH HEIGHT "solid" "lightgray")
               (/ WIDTH 2) (/ HEIGHT 2)
               (empty-scene WIDTH HEIGHT))))
